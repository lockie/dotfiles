...
you should place your code here."
  ...
  (define-key evil-normal-state-map (kbd "<end>") 'home-key-stub)
  (define-key evil-insert-state-map (kbd "<end>") 'home-key-stub)
  (define-key evil-visual-state-map (kbd "<end>") 'home-key-stub)
